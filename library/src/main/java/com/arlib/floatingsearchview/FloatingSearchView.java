    ...
    private void applyXmlAttributes(AttributeSet attrs) {
        ...
        try {
            ...
            setBackgroundColor(a.getColor(R.styleable.FloatingSearchView_floatingSearch_backgroundColor
                    , Util.getColor(getContext(), R.color.default_color)));
            ...
            setDividerColor(a.getColor(R.styleable.FloatingSearchView_floatingSearch_dividerColor
                    , Util.getColor(getContext(), R.color.transparent)));
...
//        DrawableCompat.setTint(mIconBackArrow, color);
    ...
    private void setupSuggestionSection() {
        ...
        mSuggestionsList.addItemDecoration(dividerItemDecoration);

//        mSuggestionsList.addItemDecoration(new DividerItemDecoration(mSuggestionsList.getContext(), DividerItemDecoration.VERTICAL));
